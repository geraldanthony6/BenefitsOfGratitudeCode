...
public class Grandma2NPC : NPC
{//the name of the npc
    string testName = "Granny Olivia";
    ...
    TalkBox dialo1 = new TalkBox("What have you learned today?", null, false);
    ChoiceBox dialo2 = new ChoiceBox("What have you learned?", new ChoiceBox.Choice("Be grateful!", null, true),
        new ChoiceBox.Choice("Be ungrateful!", null, false),
        new ChoiceBox.Choice("Being mean is fun!", null, false));
