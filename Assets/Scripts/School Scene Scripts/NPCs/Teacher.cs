...
//The player character's teacher before school starts (NPC)
...
public class Teacher : NPC
{
    ...
    TalkBox dialo1 = new TalkBox("Ready for class?", null, false);
    ChoiceBox dialo2 = new ChoiceBox("How do you respond?", new ChoiceBox.Choice("Yes, I'm excited!", null, true),
        new ChoiceBox.Choice("No.", null, false),
        new ChoiceBox.Choice("I hate school.", null, false));
